...
med = Dataset('/srv/ccrc/data06/z5147939/ncfiles/clust_3m/tnn_SON_2013_K_8_sil_0.1.nc', mode='r')
med_lon = med.variables['medoid_lon'][:]
med_lat = med.variables['medoid_lat'][:]

#bring in tnn dataset
ts = Dataset('/srv/ccrc/data06/z5147939/ncfiles/ds_comp_hr/tnn_ei_3m_SON.nc', mode='r')
...
#determine lat and lon of medoids
med_ap = Dataset('/srv/ccrc/data06/z5147939/ncfiles/clust_3m/tnn_ap_SON_2013_K_8_sil_0.1.nc', mode='r')
med_ap_lon = med_ap.variables['medoid_lon'][:]
med_ap_lat = med_ap.variables['medoid_lat'][:]

#bring in tnn dataset
ts_ap = Dataset('/srv/ccrc/data06/z5147939/ncfiles/ds_comp_hr/tnn_ap_3m_SON.nc', mode='r')
...
sc_n1, pv1 = stats.spearmanr(n1, an1, axis=0)
sc_n1 = "%2f" % sc_n1

#medoid 2
rmse_n2 = "%2f" % rmse(n2, an2)

sc_n2, pv2 = stats.spearmanr(n2, an2, axis=0)
sc_n2 = "%2f" % sc_n2

#medoid 3
rmse_n3 = "%2f" % rmse(n3, an4)

sc_n3, pv3 = stats.spearmanr(n3, an4, axis=0)
sc_n3 = "%2f" % sc_n3

#medoid 4
rmse_n4 = "%2f" % rmse(n4, an3)

sc_n4, pv4 = stats.spearmanr(n4, an3, axis=0)
sc_n4 = "%2f" % sc_n4

#medoid 5
rmse_n5 = "%2f" % rmse(n5, an5)

sc_n5, pv5 = stats.spearmanr(n5, an5, axis=0)
sc_n5 = "%2f" % sc_n5

#medoid 6
rmse_n6 = rmse(n6, an7)
rmse_n6 = np.round(rmse_n6, decimals=3)
sc_n6, pv6 = stats.spearmanr(n6, an7, axis=0)
sc_n6 = np.round(sc_n6, decimals=3)

#medoid 7
rmse_n7 = "%2f" % rmse(n7, an6)

sc_n7, pv7 = stats.spearmanr(n7, an6, axis=0)
sc_n7 = "%2f" % sc_n7

#medoid 8
rmse_n8 = "%2f" % rmse(n8, an8)

sc_n8, pv8 = stats.spearmanr(n8, an8, axis=0)
sc_n8 = "%2f" % sc_n8

print pv1, pv2, pv3, pv4, pv5, pv6, pv7, pv8
print stop
...
plt.title('Medoid 1', fontsize=10)
...
#ax.text(0.34,0.01,'RMSE = %s, CORR = %s' % (rmse_n6, sc_n6), transform=ax.transAxes, horizontalalignment='right', verticalalignment='bottom', fontsize=12)
...
plt.title('Medoid 3', fontsize=10)
#plt.ylabel('TNn Anomaly ($^\circ$C)', fontsize=10)
plt.ylim(-6,6)
ax.tick_params(axis='both', which='major', labelsize=8)
#
...
plt.title('Medoid 4', fontsize=10)
plt.ylabel('TNn Anomaly ($^\circ$C)', fontsize=10)
plt.ylim(-6,6)
ax.tick_params(axis='both', which='major', labelsize=8)
#
...
plt.title('Medoid 5', fontsize=10)
#plt.ylabel('TNn Anomaly ($^\circ$C)', fontsize=10)
plt.ylim(-6,6)
ax.tick_params(axis='both', which='major', labelsize=8)
#
...
plt.title('Medoid 6', fontsize=10)
#plt.ylabel('TNn Anomaly ($^\circ$C)')
plt.ylim(-6,6)
ax.tick_params(axis='both', which='major', labelsize=8)
#
...
plt.title('Medoid 7', fontsize=10)
plt.ylabel('TNn Anomaly ($^\circ$C)', fontsize=10)
plt.ylim(-6,6)
ax.tick_params(axis='both', which='major', labelsize=8)
#
...
plt.title('Medoid 8', fontsize=10)
#plt.ylabel('TNn Anomaly ($^\circ$C)')
plt.ylim(-6,6)
ax.tick_params(axis='both', which='major', labelsize=8)

plt.savefig('/home/z5147939/hdrive/figs/clust_ts_tnn_c2.png', bbox_inches='tight')
plt.show()
