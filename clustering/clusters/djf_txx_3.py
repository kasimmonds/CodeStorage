...
#era dataset
nce = Dataset('/srv/ccrc/data06/z5147939/ncfiles/clust_hr/txx_DJF_K_3_sil_0.1.nc', mode='r')
...
plt.title('ERA-Interim DJF TXx, K=3', fontsize=12)
cb.ax.tick_params(labelsize=8)
cb.set_label('Cluster mean silhouette coefficent', fontsize=10)
plt.savefig('/home/z5147939/hdrive/figs/txx_djf_3clust.png', bbox_inches='tight')
plt.show()
