...
#era dataset
nce = Dataset('/srv/ccrc/data06/z5147939/ncfiles/clust_3m/txx_DJF_2016_K_3_sil_0.1.nc', mode='r')
...
plt.title('DJF TXx, K=3, 1979-2016', fontsize=12)
cb.ax.tick_params(labelsize=8)
cb.set_label('Cluster mean silhouette coefficent', fontsize=10)
plt.savefig('/home/z5147939/hdrive/figs/txx_djf_3clust_16_3m.png', bbox_inches='tight')
plt.show()
