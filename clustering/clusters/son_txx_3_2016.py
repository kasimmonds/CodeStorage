...
##era dataset
#nce = Dataset('/srv/ccrc/data06/z5147939/ncfiles/clust_hr/tnn_SON_2016_K_10_sil_0.1.nc', mode='r')
...
##print 'cluster 9 mean = %s, lat = %s, lon = %s' % (np.mean(sil[c10]), mlat[9], mlon[9])
...
#for i in range(0,len(lat)):
  #for j in range(0,len(lon)):
      ...
      #lon_c9.append(lon[j])
      #lat_c9.append(lat[i])
    #if clust[i,j] == 10 and sil[i,j] > 0.1:
      #lon_c10.append(lon[j])
      #lat_c10.append(lat[i])
...
#for i in range(0,len(lon_c10)):
  #m.plot([mlon[9],lon_c10[i]],[mlat[9],lat_c10[i]], color='0.8', linewidth=0.75, zorder=1)
...
#ax.annotate('8.', xy = (mlon[2],mlat[2]), xytext=(5, 5), textcoords='offset points')
#ax.annotate('5.', xy = (mlon[3],mlat[3]), xytext=(5, 5), textcoords='offset points')
#ax.annotate('4.', xy = (mlon[4],mlat[4]), xytext=(5, 5), textcoords='offset points')
#ax.annotate('6.', xy = (mlon[5],mlat[5]), xytext=(5, 5), textcoords='offset points')
#ax.annotate('3.', xy = (mlon[6],mlat[6]), xytext=(5, 5), textcoords='offset points')
#ax.annotate('10.', xy = (mlon[7],mlat[7]), xytext=(5, 5), textcoords='offset points')
#ax.annotate('7.', xy = (mlon[8],mlat[8]), xytext=(5, 5), textcoords='offset points')
#ax.annotate('9.', xy = (mlon[9],mlat[9]), xytext=(5, 5), textcoords='offset points')


#cb = m.colorbar(mymap,"right", size="5%", pad="2%")
#plt.title('ERA-Interim TNn, K=10, 1979-2016', fontsize=10)
#cb.ax.tick_params(labelsize=8)
##cb.set_label('Cluster mean silhouette coefficent', fontsize=10)
#plt.savefig('/home/z5147939/hdrive/figs/tnn_son_10clust.png', bbox_inches='tight')
#plt.show()
...
ax.annotate('2.', xy = (mlona[0],mlata[0]), xytext=(5, 5), textcoords='offset points')
ax.annotate('1.', xy = (mlona[1],mlata[1]), xytext=(5, 5), textcoords='offset points')
ax.annotate('3.', xy = (mlona[2],mlata[2]), xytext=(5, 5), textcoords='offset points')


cb = m.colorbar(mymap,"right", size="5%", pad="2%")
plt.title('ERA-Interim TXx, K=3, 1979-2016', fontsize=12)
cb.ax.tick_params(labelsize=8)
cb.set_label('Cluster mean silhouette coefficent', fontsize=10)
plt.savefig('/home/z5147939/hdrive/figs/txx_son_3clust_16.png', bbox_inches='tight')
plt.show()
