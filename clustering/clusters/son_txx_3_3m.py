...
#era dataset
nce = Dataset('/srv/ccrc/data06/z5147939/ncfiles/clust_3m/txx_SON_2013_K_3_sil_0.1.nc', mode='r')
...
#awap txx k=4 data
nca = Dataset('/srv/ccrc/data06/z5147939/ncfiles/clust_3m/txx_ap_SON_2013_K_3_sil_0.1.nc', mode='r')
...
m.plot(mlona[2],mlata[2], marker='o', color='b')

m.plot(mlon[2],mlat[2], marker='D', color='w', mew=1.1, label='ERA-Interim')
ax.annotate('1.', xy = (mlon[2],mlat[2]), xytext=(5, 5), textcoords='offset points')
m.plot(mlona[1],mlata[1], marker='o', color='w', mew=1.1, label='AWAP')
...
plt.savefig('/home/z5147939/hdrive/figs/txx_son_3clust_3m.png', bbox_inches='tight')
plt.show()
