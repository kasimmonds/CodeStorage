...
#jra_mam = Dataset('/srv/ccrc/data06/z5147939/ncfiles/ds_comp_hr/tnn_jra_MAM.nc', mode='r')
#emam = jra_mam.variables['tnn'][:,:,:]
...
#jra_jja = Dataset('/srv/ccrc/data06/z5147939/ncfiles/ds_comp_hr/tnn_jra_JJA.nc', mode='r')
#ejja = jra_jja.variables['tnn'][:,:,:]
...
cb.ax.tick_params(labelsize=6)
cb.set_label('Corr(ERA-Interim, NINO3.4)', fontsize=8)
plt.savefig('/home/z5147939/hdrive/figs/tnn_jra_awap_n34.png', bbox_inches='tight')
plt.show()
