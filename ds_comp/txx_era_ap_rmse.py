...
era_djf = Dataset('/srv/ccrc/data06/z5147939/ncfiles/ds_comp_hr/txx_ei_3m_DJF.nc', mode='r')
edjf = era_djf.variables['txx'][:,:,:]
...
#era_mam = Dataset('/srv/ccrc/data06/z5147939/ncfiles/ds_comp_hr/txx_ei_MAM.nc', mode='r')
#emam = era_mam.variables['txx'][:,:,:]
...
#era_jja = Dataset('/srv/ccrc/data06/z5147939/ncfiles/ds_comp_hr/txx_ei_JJA.nc', mode='r')
#ejja = era_jja.variables['txx'][:,:,:]
...
era_son = Dataset('/srv/ccrc/data06/z5147939/ncfiles/ds_comp_hr/txx_ei_3m_SON.nc', mode='r')
eson = era_son.variables['txx'][:,:,:]
...
cb.ax.tick_params(labelsize=6)
cb.set_label('Corr(ERA-Interim, NINO3.4)', fontsize=8)
plt.savefig('/home/z5147939/hdrive/figs/txx_era_awap_n34.png', bbox_inches='tight')
plt.show()
