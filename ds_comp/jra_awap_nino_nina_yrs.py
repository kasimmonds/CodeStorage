...
era_txx_e = Dataset('/srv/ccrc/data06/z5147939/ncfiles/ds_comp_hr/txx_jra_3m_DJF_nino.nc', mode='r')
...
era_txx_l = Dataset('/srv/ccrc/data06/z5147939/ncfiles/ds_comp_hr/txx_jra_3m_DJF_nina.nc', mode='r')
...
era_tnn_e = Dataset('/srv/ccrc/data06/z5147939/ncfiles/ds_comp_hr/tnn_jra_3m_DJF_nino.nc', mode='r')
...
era_tnn_l = Dataset('/srv/ccrc/data06/z5147939/ncfiles/ds_comp_hr/tnn_jra_3m_DJF_nina.nc', mode='r')
...
cb.set_label('AWAP - JRA-55', fontsize=8)
...
plt.savefig('/home/z5147939/hdrive/figs/jra_awap_comp.png', bbox_inches='tight')
#plt.show()
