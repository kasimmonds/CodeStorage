...
ds_tnn = nc.Dataset('/home/z5147939/ncfiles/comp_ds/JRA55.TN.daily.1979-2013_aus.nc','r')
#ds_tnn = nc.Dataset('/srv/ccrc/data06/z5147939/ncfiles/ERA-Int/JRA55.TN.daily.1958-2014.nc','r')
#calendar = ds_tnn.variables['time'].calendar
units = ds_tnn.variables['time'].units
lon = ds_tnn.variables['lon'][:]
lat = ds_tnn.variables['lat'][:]
tn = ds_tnn.variables['TN'][:,:,:]
...
#write nc file 
f = nc.Dataset('/srv/ccrc/data06/z5147939/ncfiles/ERA-Int/tnn_JRA55_1979-2013_aus.nc','w')
...
#description
f.description = 'JRA55 TNn and date occured over Australia'
f.history = 'Created 27/06/2017'
f.source = 'Global TN data from /srv/ccrc/data43/z3506872/datasets/JRA55_CISL/t2m_minmax/JRA55.TN.daily.1958-2013.nc'
#close
f.close()
