...
#rsds
ds_rsds = nc.Dataset('/srv/ccrc/data06/z5147939/datasets/era/rsds_4am_flux.nc', mode='r')
...
#write nc file 
f = nc.Dataset('/srv/ccrc/data06/z5147939/datasets/era/rsds_tnn_son_3m.nc','w')
