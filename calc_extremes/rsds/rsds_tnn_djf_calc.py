...
med = nc.Dataset('/srv/ccrc/data06/z5147939/ncfiles/clust_3m/tnn_DJF_2016_K_13_sil_0.1.nc', mode='r')
...
#n3 = ts.variables['tnn'][:,lat_idx_n1,lon_idx_n1]
#n8 = ts.variables['tnn'][:,lat_idx_n2, lon_idx_n2]
#n7 = ts.variables['tnn'][:,lat_idx_n3,lon_idx_n3]
#n5 = ts.variables['tnn'][:,lat_idx_n4,lon_idx_n4]
#n4 = ts.variables['tnn'][:,lat_idx_n5,lon_idx_n5]
#n12 = ts.variables['tnn'][:,lat_idx_n6,lon_idx_n6]
#n2 = ts.variables['tnn'][:,lat_idx_n7,lon_idx_n7]
#n6 = ts.variables['tnn'][:,lat_idx_n8,lon_idx_n8]
#n1 = ts.variables['tnn'][:,lat_idx_n9,lon_idx_n9]
#n13 = ts.variables['tnn'][:,lat_idx_n10,lon_idx_n10]
#n9 = ts.variables['tnn'][:,lat_idx_n11,lon_idx_n11]
#n11 = ts.variables['tnn'][:,lat_idx_n12,lon_idx_n12]
#n10 = ts.variables['tnn'][:,lat_idx_n13,lon_idx_n13]

#clusters
ts = nc.Dataset('/srv/ccrc/data06/z5147939/datasets/era/tnn_era_1979-2016_aus.nc', mode='r')
day_c3 = ts.variables['day'][:,lat_idx_n1,lon_idx_n1]
day_c8 = ts.variables['day'][:,lat_idx_n2, lon_idx_n2]
day_c7 = ts.variables['day'][:,lat_idx_n3,lon_idx_n3]
day_c5 = ts.variables['day'][:,lat_idx_n4,lon_idx_n4]
day_c4 = ts.variables['day'][:,lat_idx_n5,lon_idx_n5]
day_c12 = ts.variables['day'][:,lat_idx_n6,lon_idx_n6]
day_c2 = ts.variables['day'][:,lat_idx_n7,lon_idx_n7]
...
#rsds
ds_rsds = nc.Dataset('/srv/ccrc/data06/z5147939/datasets/era/rsds_era_4am_aus.nc', mode='r')
...
rsds_c8 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
rsds_c9 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
rsds_c10 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
rsds_c11 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
rsds_c12 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
rsds_c13 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
...
#for i in range(0,2):
  ...
  #for j in range(0,2):
	...
	rsds_c8[t,i,j]  = rsds[i_year[i_month[i_day_c8]],i,j]
	rsds_c9[t,i,j]  = rsds[i_year[i_month[i_day_c9]],i,j]
	rsds_c10[t,i,j]  = rsds[i_year[i_month[i_day_c10]],i,j]
	rsds_c11[t,i,j]  = rsds[i_year[i_month[i_day_c11]],i,j]
	rsds_c12[t,i,j]  = rsds[i_year[i_month[i_day_c12]],i,j]
	rsds_c13[t,i,j]  = rsds[i_year[i_month[i_day_c13]],i,j]
...
#write nc file 
f = nc.Dataset('/srv/ccrc/data06/z5147939/datasets/era/rsds_tnn_djf_3m.nc','w')
...
rsds_c1_v.long_name='Low cloud cover occurring when medoid 1 is at tnn'
rsds_c1_v.units='Fraction'

#rsds_c2
rsds_c2_v = f.createVariable('rsds_c2', 'f4', ('time', 'lat', 'lon',))
rsds_c2_v.long_name='Low cloud cover occurring when medoid 2 is at tnn'
rsds_c2_v.units='Fraction'

#rsds_c3
rsds_c3_v = f.createVariable('rsds_c3', 'f4', ('time', 'lat', 'lon',))
rsds_c3_v.long_name='Low cloud cover occurring when medoid 2 is at tnn'
rsds_c3_v.units='Fraction'

#rsds_c4
rsds_c4_v = f.createVariable('rsds_c4', 'f4', ('time', 'lat', 'lon',))
rsds_c4_v.long_name='Low cloud cover occurring when medoid 4 is at tnn'
rsds_c4_v.units='Fraction'

#rsds_c5
rsds_c5_v = f.createVariable('rsds_c5', 'f4', ('time', 'lat', 'lon',))
rsds_c5_v.long_name='Low cloud cover occurring when medoid 5 is at tnn'
rsds_c5_v.units='Fraction'

#rsds_c6
rsds_c6_v = f.createVariable('rsds_c6', 'f4', ('time', 'lat', 'lon',))
rsds_c6_v.long_name='Low cloud cover occurring when medoid 6 is at tnn'
rsds_c6_v.units='Fraction'


#rsds_c7
rsds_c7_v = f.createVariable('rsds_c7', 'f4', ('time', 'lat', 'lon',))
rsds_c7_v.long_name='Low cloud cover occurring when medoid 7 is at tnn'
rsds_c7_v.units='Fraction'

#rsds_c8
rsds_c8_v = f.createVariable('rsds_c8', 'f4', ('time', 'lat', 'lon',))
rsds_c8_v.long_name='Low cloud cover occurring when medoid 8 is at tnn'
rsds_c8_v.units='Fraction'

#rsds_c9
rsds_c9_v = f.createVariable('rsds_c9', 'f4', ('time', 'lat', 'lon',))
rsds_c9_v.long_name='Low cloud cover occurring when medoid 9 is at tnn'
rsds_c9_v.units='Fraction'

#rsds_c10
rsds_c10_v = f.createVariable('rsds_c10', 'f10', ('time', 'lat', 'lon',))
rsds_c10_v.long_name='Low cloud cover occurring when medoid 10 is at tnn'
rsds_c10_v.units='Fraction'

#rsds_c11
rsds_c11_v = f.createVariable('rsds_c11', 'f4', ('time', 'lat', 'lon',))
rsds_c11_v.long_name='Low cloud cover occurring when medoid 11 is at tnn'
rsds_c11_v.units='Fraction'


#rsds_c12
rsds_c12_v = f.createVariable('rsds_c12', 'f4', ('time', 'lat', 'lon',))
rsds_c12_v.long_name='Low cloud cover occurring when medoid 12 is at tnn'
rsds_c12_v.units='Fraction'

#rsds_c13
rsds_c13_v = f.createVariable('rsds_c13', 'f4', ('time', 'lat', 'lon',))
rsds_c13_v.long_name='Low cloud cover occurring when medoid 13 is at tnn'
rsds_c13_v.units='Fraction'
