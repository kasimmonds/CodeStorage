...
#lcc
ds_lcc = nc.Dataset('/srv/ccrc/data06/z5147939/datasets/era/lcc_day_mn_aus.nc', mode='r')
...
#write nc file 
f = nc.Dataset('/srv/ccrc/data06/z5147939/datasets/era/lcc_txx_djf_day.nc','w')
...
#description
f.description = 'LCC (ERA-Interim) at dates where medoids are at TXx in DJF, extremes not averaged.'
