...
#write nc file 
f = nc.Dataset('/srv/ccrc/data06/z5147939/datasets/era/mslp_tnn_son_3m.nc','w')
...
mslp_c1_v.long_name='Low cloud cover occurring when medoid 1 is at TXx'
mslp_c1_v.units='Fraction'

#mslp_c2
mslp_c2_v = f.createVariable('mslp_c2', 'f4', ('time', 'lat', 'lon',))
mslp_c2_v.long_name='Low cloud cover occurring when medoid 2 is at TXx'
mslp_c2_v.units='Fraction'

#mslp_c3
mslp_c3_v = f.createVariable('mslp_c3', 'f4', ('time', 'lat', 'lon',))
mslp_c3_v.long_name='Low cloud cover occurring when medoid 2 is at TXx'
mslp_c3_v.units='Fraction'

#mslp_c4
mslp_c4_v = f.createVariable('mslp_c4', 'f4', ('time', 'lat', 'lon',))
mslp_c4_v.long_name='Low cloud cover occurring when medoid 4 is at TXx'
mslp_c4_v.units='Fraction'

#mslp_c5
mslp_c5_v = f.createVariable('mslp_c5', 'f4', ('time', 'lat', 'lon',))
mslp_c5_v.long_name='Low cloud cover occurring when medoid 5 is at TXx'
mslp_c5_v.units='Fraction'

#mslp_c6
mslp_c6_v = f.createVariable('mslp_c6', 'f4', ('time', 'lat', 'lon',))
mslp_c6_v.long_name='Low cloud cover occurring when medoid 6 is at TXx'
mslp_c6_v.units='Fraction'


#mslp_c7
mslp_c7_v = f.createVariable('mslp_c7', 'f4', ('time', 'lat', 'lon',))
mslp_c7_v.long_name='Low cloud cover occurring when medoid 7 is at TXx'
...
#description
f.description = 'Mean sea level pressure (ERA-Interim) at dates where medoids are at TNn in SON, extremes not averaged.'
f.history = 'Created 14/08/2017'
f.source = 'Global MSLP data from raijin.nci.org.au:/g/data1/ub4/erai/netcdf/6hr/atmos/oper_an_ml/v01/psl/'
#close
f.close()
