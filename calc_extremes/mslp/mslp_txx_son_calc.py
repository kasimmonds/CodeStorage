...
#write nc file 
f = nc.Dataset('/srv/ccrc/data06/z5147939/datasets/era/mslp_txx_son_7clust.nc','w')
...
#description
f.description = 'Mean sea level pressure (ERA-Interim) at dates where medoids are at TXx in SON, extremes not averaged.'
