...
#clt
ds_clt = nc.Dataset('/srv/ccrc/data06/z5147939/datasets/era/clt_4am_aus.nc', mode='r')
clt = ds_clt.variables['clt'][:]
time = ds_clt.variables['time'][:]
calendar = ds_clt.variables['time'].calendar
units = ds_clt.variables['time'].units
lon = ds_clt.variables['lon'][:]
lat = ds_clt.variables['lat'][:]
...
clt_c1 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
clt_c2 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
clt_c3 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
clt_c4 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
clt_c5 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
clt_c6 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
clt_c7 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
#clt_c8 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
#clt_c9 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
#clt_c10 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
#clt_c11 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
#clt_c12 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
#clt_c13 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
...
#for i in range(0,2):
  ...
  #for j in range(0,2):
	...
	#print clt[i_year[i_month[i_day_c2]],i,j], day_c2[t], month_l[m], year_l[y]
	clt_c1[t,i,j]  = clt[i_year[i_month[i_day_c1]],i,j]
	clt_c2[t,i,j]  = clt[i_year[i_month[i_day_c2]],i,j]
	clt_c3[t,i,j]  = clt[i_year[i_month[i_day_c3]],i,j]
	clt_c4[t,i,j]  = clt[i_year[i_month[i_day_c4]],i,j]
	clt_c5[t,i,j]  = clt[i_year[i_month[i_day_c5]],i,j]
	clt_c6[t,i,j]  = clt[i_year[i_month[i_day_c6]],i,j]
	clt_c7[t,i,j]  = clt[i_year[i_month[i_day_c7]],i,j]
	#clt_c8[t,i,j]  = clt[i_year[i_month[i_day_c8]],i,j]
	#clt_c9[t,i,j]  = clt[i_year[i_month[i_day_c9]],i,j]
	#clt_c10[t,i,j]  = clt[i_year[i_month[i_day_c10]],i,j]
	#clt_c11[t,i,j]  = clt[i_year[i_month[i_day_c11]],i,j]
	#clt_c12[t,i,j]  = clt[i_year[i_month[i_day_c12]],i,j]
	#clt_c13[t,i,j]  = clt[i_year[i_month[i_day_c13]],i,j]
	#print clt_c1[t,i,j], clt_c2[t,i,j], clt_c3[t,i,j]
	t=t+1
...
#write nc file
f = nc.Dataset('/srv/ccrc/data06/z5147939/datasets/era/clt_tnn_djf_4am.nc','w')
...
#create 3D variables
#clt_c1
clt_c1_v = f.createVariable('clt_c1', 'f4', ('time', 'lat', 'lon',))
clt_c1_v.long_name='total cloud cover occurring when medoid 1 is at tnn'
clt_c1_v.units='Fraction'

#clt_c2
clt_c2_v = f.createVariable('clt_c2', 'f4', ('time', 'lat', 'lon',))
clt_c2_v.long_name='total cloud cover occurring when medoid 2 is at tnn'
clt_c2_v.units='Fraction'

#clt_c3
clt_c3_v = f.createVariable('clt_c3', 'f4', ('time', 'lat', 'lon',))
clt_c3_v.long_name='total cloud cover occurring when medoid 2 is at tnn'
clt_c3_v.units='Fraction'

#clt_c4
clt_c4_v = f.createVariable('clt_c4', 'f4', ('time', 'lat', 'lon',))
clt_c4_v.long_name='total cloud cover occurring when medoid 4 is at tnn'
clt_c4_v.units='Fraction'

#clt_c5
clt_c5_v = f.createVariable('clt_c5', 'f4', ('time', 'lat', 'lon',))
clt_c5_v.long_name='total cloud cover occurring when medoid 5 is at tnn'
clt_c5_v.units='Fraction'

#clt_c6
clt_c6_v = f.createVariable('clt_c6', 'f4', ('time', 'lat', 'lon',))
clt_c6_v.long_name='total cloud cover occurring when medoid 6 is at tnn'
clt_c6_v.units='Fraction'


#clt_c7
clt_c7_v = f.createVariable('clt_c7', 'f4', ('time', 'lat', 'lon',))
clt_c7_v.long_name='total cloud cover occurring when medoid 7 is at tnn'
clt_c7_v.units='Fraction'

##clt_c8
#clt_c8_v = f.createVariable('clt_c8', 'f4', ('time', 'lat', 'lon',))
#clt_c8_v.long_name='total cloud cover occurring when medoid 8 is at tnn'
#clt_c8_v.units='Fraction'

##clt_c9
#clt_c9_v = f.createVariable('clt_c9', 'f4', ('time', 'lat', 'lon',))
#clt_c9_v.long_name='total cloud cover occurring when medoid 9 is at tnn'
#clt_c9_v.units='Fraction'

##clt_c10
#clt_c10_v = f.createVariable('clt_c10', 'f10', ('time', 'lat', 'lon',))
#clt_c10_v.long_name='total cloud cover occurring when medoid 10 is at tnn'
#clt_c10_v.units='Fraction'

##clt_c11
#clt_c11_v = f.createVariable('clt_c11', 'f4', ('time', 'lat', 'lon',))
#clt_c11_v.long_name='total cloud cover occurring when medoid 11 is at tnn'
#clt_c11_v.units='Fraction'


##clt_c12
#clt_c12_v = f.createVariable('clt_c12', 'f4', ('time', 'lat', 'lon',))
#clt_c12_v.long_name='total cloud cover occurring when medoid 12 is at tnn'
#clt_c12_v.units='Fraction'

##clt_c13
#clt_c13_v = f.createVariable('clt_c13', 'f4', ('time', 'lat', 'lon',))
#clt_c13_v.long_name='total cloud cover occurring when medoid 13 is at tnn'
#clt_c13_v.units='Fraction'
...
#description
f.description = 'total cloud cover (ERA-Interim) at dates where medoids are at TNn in DJF.'
f.history = 'Created 24/08/2017'
f.source = 'Global clt data from raijin.nci.org.au:/g/data1/ub4/erai/netcdf/6hr/atmos/oper_an_ml/v01/clt/'
#close
f.close()
