...
#write nc file 
f = nc.Dataset('/srv/ccrc/data06/z5147939/datasets/era/hfls_txx_son_7clust.nc','w')
...
#description
f.description = 'hfls (ERA-Interim) at dates where medoids are at TXx in SON, extremes not averaged.'
