...
#hfls
ds_hfls = nc.Dataset('/srv/ccrc/data06/z5147939/datasets/era/hfls_4am_flux.nc', mode='r')
...
#hfls_c8 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
#hfls_c9 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
#hfls_c10 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
#hfls_c11 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
#hfls_c12 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
#hfls_c13 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
...
#for i in range(0,2):
  ...
  #for j in range(0,2):
	...
	#hfls_c8[t,i,j]  = hfls[i_year[i_month[i_day_c8]],i,j]
	#hfls_c9[t,i,j]  = hfls[i_year[i_month[i_day_c9]],i,j]
	#hfls_c10[t,i,j]  = hfls[i_year[i_month[i_day_c10]],i,j]
	#hfls_c11[t,i,j]  = hfls[i_year[i_month[i_day_c11]],i,j]
	#hfls_c12[t,i,j]  = hfls[i_year[i_month[i_day_c12]],i,j]
	#hfls_c13[t,i,j]  = hfls[i_year[i_month[i_day_c13]],i,j]
...
#write nc file 
f = nc.Dataset('/srv/ccrc/data06/z5147939/datasets/era/hfls_tnn_djf_7clust.nc','w')
...
hfls_c1_v.long_name='Low cloud cover occurring when medoid 1 is at tnn'
hfls_c1_v.units='Fraction'

#hfls_c2
hfls_c2_v = f.createVariable('hfls_c2', 'f4', ('time', 'lat', 'lon',))
hfls_c2_v.long_name='Low cloud cover occurring when medoid 2 is at tnn'
hfls_c2_v.units='Fraction'

#hfls_c3
hfls_c3_v = f.createVariable('hfls_c3', 'f4', ('time', 'lat', 'lon',))
hfls_c3_v.long_name='Low cloud cover occurring when medoid 2 is at tnn'
hfls_c3_v.units='Fraction'

#hfls_c4
hfls_c4_v = f.createVariable('hfls_c4', 'f4', ('time', 'lat', 'lon',))
hfls_c4_v.long_name='Low cloud cover occurring when medoid 4 is at tnn'
hfls_c4_v.units='Fraction'

#hfls_c5
hfls_c5_v = f.createVariable('hfls_c5', 'f4', ('time', 'lat', 'lon',))
hfls_c5_v.long_name='Low cloud cover occurring when medoid 5 is at tnn'
hfls_c5_v.units='Fraction'

#hfls_c6
hfls_c6_v = f.createVariable('hfls_c6', 'f4', ('time', 'lat', 'lon',))
hfls_c6_v.long_name='Low cloud cover occurring when medoid 6 is at tnn'
hfls_c6_v.units='Fraction'


#hfls_c7
hfls_c7_v = f.createVariable('hfls_c7', 'f4', ('time', 'lat', 'lon',))
hfls_c7_v.long_name='Low cloud cover occurring when medoid 7 is at tnn'
hfls_c7_v.units='Fraction'

##hfls_c8
#hfls_c8_v = f.createVariable('hfls_c8', 'f4', ('time', 'lat', 'lon',))
#hfls_c8_v.long_name='Low cloud cover occurring when medoid 8 is at tnn'
#hfls_c8_v.units='Fraction'

##hfls_c9
#hfls_c9_v = f.createVariable('hfls_c9', 'f4', ('time', 'lat', 'lon',))
#hfls_c9_v.long_name='Low cloud cover occurring when medoid 9 is at tnn'
#hfls_c9_v.units='Fraction'

##hfls_c10
#hfls_c10_v = f.createVariable('hfls_c10', 'f10', ('time', 'lat', 'lon',))
#hfls_c10_v.long_name='Low cloud cover occurring when medoid 10 is at tnn'
#hfls_c10_v.units='Fraction'

##hfls_c11
#hfls_c11_v = f.createVariable('hfls_c11', 'f4', ('time', 'lat', 'lon',))
#hfls_c11_v.long_name='Low cloud cover occurring when medoid 11 is at tnn'
#hfls_c11_v.units='Fraction'


##hfls_c12
#hfls_c12_v = f.createVariable('hfls_c12', 'f4', ('time', 'lat', 'lon',))
#hfls_c12_v.long_name='Low cloud cover occurring when medoid 12 is at tnn'
#hfls_c12_v.units='Fraction'

##hfls_c13
#hfls_c13_v = f.createVariable('hfls_c13', 'f4', ('time', 'lat', 'lon',))
#hfls_c13_v.long_name='Low cloud cover occurring when medoid 13 is at tnn'
#hfls_c13_v.units='Fraction'
...
#description
f.description = 'latent heat flux (ERA-Interim) at dates where medoids are at TNn in DJF.'
