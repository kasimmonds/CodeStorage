...
#hfss
ds_hfss = nc.Dataset('/srv/ccrc/data06/z5147939/datasets/era/hfss_4am_flux.nc', mode='r')
...
hfss_c1 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
hfss_c2 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
hfss_c3 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
hfss_c4 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
hfss_c5 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
hfss_c6 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
hfss_c7 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
#hfss_c8 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
#hfss_c9 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
#hfss_c10 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
#hfss_c11 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
#hfss_c12 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
#hfss_c13 = np.zeros(((12*(2017-1979)), len(lat), len(lon)), dtype='float32')
...
#for i in range(0,2):
  ...
  #for j in range(0,2):
	...
	#print hfss[i_year[i_month[i_day_c2]],i,j], day_c2[t], month_l[m], year_l[y] 
	hfss_c1[t,i,j]  = hfss[i_year[i_month[i_day_c1]],i,j]
	hfss_c2[t,i,j]  = hfss[i_year[i_month[i_day_c2]],i,j]
	hfss_c3[t,i,j]  = hfss[i_year[i_month[i_day_c3]],i,j]
	hfss_c4[t,i,j]  = hfss[i_year[i_month[i_day_c4]],i,j]
	hfss_c5[t,i,j]  = hfss[i_year[i_month[i_day_c5]],i,j]
	hfss_c6[t,i,j]  = hfss[i_year[i_month[i_day_c6]],i,j]
	hfss_c7[t,i,j]  = hfss[i_year[i_month[i_day_c7]],i,j]
	#hfss_c8[t,i,j]  = hfss[i_year[i_month[i_day_c8]],i,j]
	#hfss_c9[t,i,j]  = hfss[i_year[i_month[i_day_c9]],i,j]
	#hfss_c10[t,i,j]  = hfss[i_year[i_month[i_day_c10]],i,j]
	#hfss_c11[t,i,j]  = hfss[i_year[i_month[i_day_c11]],i,j]
	#hfss_c12[t,i,j]  = hfss[i_year[i_month[i_day_c12]],i,j]
	#hfss_c13[t,i,j]  = hfss[i_year[i_month[i_day_c13]],i,j]
	#print hfss_c1[t,i,j], hfss_c2[t,i,j], hfss_c3[t,i,j]
	t=t+1
...
#write nc file 
f = nc.Dataset('/srv/ccrc/data06/z5147939/datasets/era/hfss_tnn_djf_7clust.nc','w')
...
#create 3D variables
#hfss_c1
hfss_c1_v = f.createVariable('hfss_c1', 'f4', ('time', 'lat', 'lon',))
hfss_c1_v.long_name='Low cloud cover occurring when medoid 1 is at tnn'
hfss_c1_v.units='Fraction'

#hfss_c2
hfss_c2_v = f.createVariable('hfss_c2', 'f4', ('time', 'lat', 'lon',))
hfss_c2_v.long_name='Low cloud cover occurring when medoid 2 is at tnn'
hfss_c2_v.units='Fraction'

#hfss_c3
hfss_c3_v = f.createVariable('hfss_c3', 'f4', ('time', 'lat', 'lon',))
hfss_c3_v.long_name='Low cloud cover occurring when medoid 2 is at tnn'
hfss_c3_v.units='Fraction'

#hfss_c4
hfss_c4_v = f.createVariable('hfss_c4', 'f4', ('time', 'lat', 'lon',))
hfss_c4_v.long_name='Low cloud cover occurring when medoid 4 is at tnn'
hfss_c4_v.units='Fraction'

#hfss_c5
hfss_c5_v = f.createVariable('hfss_c5', 'f4', ('time', 'lat', 'lon',))
hfss_c5_v.long_name='Low cloud cover occurring when medoid 5 is at tnn'
hfss_c5_v.units='Fraction'

#hfss_c6
hfss_c6_v = f.createVariable('hfss_c6', 'f4', ('time', 'lat', 'lon',))
hfss_c6_v.long_name='Low cloud cover occurring when medoid 6 is at tnn'
hfss_c6_v.units='Fraction'


#hfss_c7
hfss_c7_v = f.createVariable('hfss_c7', 'f4', ('time', 'lat', 'lon',))
hfss_c7_v.long_name='Low cloud cover occurring when medoid 7 is at tnn'
hfss_c7_v.units='Fraction'

##hfss_c8
#hfss_c8_v = f.createVariable('hfss_c8', 'f4', ('time', 'lat', 'lon',))
#hfss_c8_v.long_name='Low cloud cover occurring when medoid 8 is at tnn'
#hfss_c8_v.units='Fraction'

##hfss_c9
#hfss_c9_v = f.createVariable('hfss_c9', 'f4', ('time', 'lat', 'lon',))
#hfss_c9_v.long_name='Low cloud cover occurring when medoid 9 is at tnn'
#hfss_c9_v.units='Fraction'

##hfss_c10
#hfss_c10_v = f.createVariable('hfss_c10', 'f10', ('time', 'lat', 'lon',))
#hfss_c10_v.long_name='Low cloud cover occurring when medoid 10 is at tnn'
#hfss_c10_v.units='Fraction'

##hfss_c11
#hfss_c11_v = f.createVariable('hfss_c11', 'f4', ('time', 'lat', 'lon',))
#hfss_c11_v.long_name='Low cloud cover occurring when medoid 11 is at tnn'
#hfss_c11_v.units='Fraction'


##hfss_c12
#hfss_c12_v = f.createVariable('hfss_c12', 'f4', ('time', 'lat', 'lon',))
#hfss_c12_v.long_name='Low cloud cover occurring when medoid 12 is at tnn'
#hfss_c12_v.units='Fraction'

##hfss_c13
#hfss_c13_v = f.createVariable('hfss_c13', 'f4', ('time', 'lat', 'lon',))
#hfss_c13_v.long_name='Low cloud cover occurring when medoid 13 is at tnn'
#hfss_c13_v.units='Fraction'
...
#description
f.description = 'sensible heat flux (ERA-Interim) at dates where medoids are at TNn in DJF.'
