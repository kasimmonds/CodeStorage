...
#write nc file 
f = nc.Dataset('/srv/ccrc/data06/z5147939/datasets/era/hfss_txx_djf_7clust.nc','w')
...
#description
f.description = 'hfss (ERA-Interim) at dates where medoids are at TXx in DJF, extremes not averaged.'
