...
plt.title('TNn DJF Cluster 1', fontsize=10)
...
v = np.linspace( -15, 15, 31, endpoint=True)
norm = colors.BoundaryNorm(boundaries=v, ncolors=256)
...
v = np.linspace( -0.23, 0.23, 24, endpoint=True)
norm = colors.BoundaryNorm(boundaries=v, ncolors=256)
...
plt.savefig('/home/z5147939/hdrive/figs/tnn_djf_c1_enso.png', bbox_inches='tight')
#plt.show()
