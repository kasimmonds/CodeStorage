...
lat_idx_n1 = geo_idx(mlat[3], lat)
lon_idx_n1 = geo_idx(mlon[3], lon)
...
strd_nino = strd.variables['strd_c6'][:,:,:]

strda = Dataset('/srv/ccrc/data06/z5147939/ncfiles/7corr/strd_tnn_comp_DJF_nina.nc', mode='r')
strd_nina = strda.variables['strd_c6'][:,:,:]

strdn = Dataset('/srv/ccrc/data06/z5147939/ncfiles/7corr/strd_tnn_comp_DJF.nc', mode='r')
strd_neut = strdn.variables['strd_c6'][:,:,:]

#bring in hfls
hfls = Dataset('/srv/ccrc/data06/z5147939/ncfiles/7corr/hfls_tnn_comp_DJF_nino.nc', mode='r')
hfls_nino = hfls.variables['hfls_c6'][:,:,:]

hflsa = Dataset('/srv/ccrc/data06/z5147939/ncfiles/7corr/hfls_tnn_comp_DJF_nina.nc', mode='r')
hfls_nina = hflsa.variables['hfls_c6'][:,:,:]

hflsn = Dataset('/srv/ccrc/data06/z5147939/ncfiles/7corr/hfls_tnn_comp_DJF.nc', mode='r')
hfls_neut = hflsn.variables['hfls_c6'][:,:,:]


#bring in hfss
hfss = Dataset('/srv/ccrc/data06/z5147939/ncfiles/7corr/hfss_tnn_comp_DJF_nino.nc', mode='r')
hfss_nino = hfss.variables['hfss_c6'][:,:,:]

hfssa = Dataset('/srv/ccrc/data06/z5147939/ncfiles/7corr/hfss_tnn_comp_DJF_nina.nc', mode='r')
hfss_nina = hfssa.variables['hfss_c6'][:,:,:]

hfssn = Dataset('/srv/ccrc/data06/z5147939/ncfiles/7corr/hfss_tnn_comp_DJF.nc', mode='r')
hfss_neut = hfssn.variables['hfss_c6'][:,:,:]

#ef_c1 = hfls_c1/(hfls_c1 + hfss_c1)

#clt
clt = Dataset('/srv/ccrc/data06/z5147939/ncfiles/7corr/clt_tnn_comp_DJF_nino.nc', mode='r')
clt_nino = clt.variables['clt_c6'][:,:,:]

clta = Dataset('/srv/ccrc/data06/z5147939/ncfiles/7corr/clt_tnn_comp_DJF_nina.nc', mode='r')
clt_nina = clta.variables['clt_c6'][:,:,:]

cltn = Dataset('/srv/ccrc/data06/z5147939/ncfiles/7corr/clt_tnn_comp_DJF.nc', mode='r')
clt_neut = cltn.variables['clt_c6'][:,:,:]
...
mslp_nino = mslp.variables['mslp_c6'][:,:,:]

mslpa = Dataset('/srv/ccrc/data06/z5147939/ncfiles/7corr/mslp_tnn_comp_DJF_nina.nc', mode='r')
mslp_nina = mslpa.variables['mslp_c6'][:,:,:]

mslpn = Dataset('/srv/ccrc/data06/z5147939/ncfiles/7corr/mslp_tnn_comp_DJF.nc', mode='r')
mslp_neut = mslpn.variables['mslp_c6'][:,:,:]
...
v = np.linspace( -24, 24, 13, endpoint=True)
norm = colors.BoundaryNorm(boundaries=v, ncolors=256)
...
plt.title('Longwave down', fontsize=10)
ax.set_ylabel('El Nino', labelpad=20)
ax.text(0.15,0.05,'a)', transform=ax.transAxes, horizontalalignment='right', verticalalignment='bottom', fontsize=10, fontweight='bold')
...
ax.text(0.15,0.05,'f)', transform=ax.transAxes, horizontalalignment='right', verticalalignment='bottom', fontsize=10, fontweight='bold')
...
cb.set_label('$W/m^2$', fontsize=9)
#plt.title('Longwave downwards', fontsize=10)
ax.set_ylabel('All', labelpad=20)
ax.text(0.15,0.05,'k)', transform=ax.transAxes, horizontalalignment='right', verticalalignment='bottom', fontsize=10, fontweight='bold')
#hfls
...
ax.text(0.15,0.05,'b)', transform=ax.transAxes, horizontalalignment='right', verticalalignment='bottom', fontsize=10, fontweight='bold')
...
for label in cb.ax.yaxis.get_ticklabels()[1::2]:
    label.set_visible(False)
cb.set_label('$W/m^2$', fontsize=9)
ax.text(0.15,0.05,'g)', transform=ax.transAxes, horizontalalignment='right', verticalalignment='bottom', fontsize=10, fontweight='bold')
#plt.title('Latent heat flux', fontsize=10)
...
for label in cb.ax.yaxis.get_ticklabels()[1::2]:
    label.set_visible(False)
cb.set_label('$W/m^2$', fontsize=9)
ax.text(0.15,0.05,'l)', transform=ax.transAxes, horizontalalignment='right', verticalalignment='bottom', fontsize=10, fontweight='bold')
#plt.title('Latent heat flux', fontsize=10)
...
ax.text(0.15,0.05,'c)', transform=ax.transAxes, horizontalalignment='right', verticalalignment='bottom', fontsize=10, fontweight='bold')
...
for label in cb.ax.yaxis.get_ticklabels()[1::2]:
    label.set_visible(False)
cb.set_label('$W/m^2$', fontsize=9)
ax.text(0.15,0.05,'h)', transform=ax.transAxes, horizontalalignment='right', verticalalignment='bottom', fontsize=10, fontweight='bold')
...
ax.text(0.15,0.05,'m)', transform=ax.transAxes, horizontalalignment='right', verticalalignment='bottom', fontsize=10, fontweight='bold')
...
v = np.linspace( -0.3, 0.3, 13, endpoint=True)
norm = colors.BoundaryNorm(boundaries=v, ncolors=256)
...
for label in cb.ax.yaxis.get_ticklabels()[1::2]:
    label.set_visible(False)
cb.ax.tick_params(labelsize=8)
cb.set_label('Fraction', fontsize=9)
plt.title('Total cloud cover', fontsize=10)
ax.text(0.15,0.05,'d)', transform=ax.transAxes, horizontalalignment='right', verticalalignment='bottom', fontsize=10, fontweight='bold')
...
cb.ax.tick_params(labelsize=8)
cb.set_label('Fraction', fontsize=9)
ax.text(0.15,0.05,'i)', transform=ax.transAxes, horizontalalignment='right', verticalalignment='bottom', fontsize=10, fontweight='bold')
...
cb.ax.tick_params(labelsize=8)
cb.set_label('Fraction', fontsize=9)
ax.text(0.15,0.05,'n)', transform=ax.transAxes, horizontalalignment='right', verticalalignment='bottom', fontsize=10, fontweight='bold')
#plt.title('Total cloud cover', fontsize=10)
...
v = np.linspace( -600, 600, 13, endpoint=True)
norm = colors.BoundaryNorm(boundaries=v, ncolors=256)
...
for label in cb.ax.yaxis.get_ticklabels()[1::2]:
    label.set_visible(False)
cb.set_label('Pa', fontsize=9)
plt.title('Mean sea level pressure', fontsize=10)
ax.text(0.15,0.05,'e)', transform=ax.transAxes, horizontalalignment='right', verticalalignment='bottom', fontsize=10, fontweight='bold')
...
for label in cb.ax.yaxis.get_ticklabels()[1::2]:
    label.set_visible(False)
cb.set_label('Pa', fontsize=9)
ax.text(0.15,0.05,'j)', transform=ax.transAxes, horizontalalignment='right', verticalalignment='bottom', fontsize=10, fontweight='bold')
...
for label in cb.ax.yaxis.get_ticklabels()[1::2]:
    label.set_visible(False)
cb.set_label('Pa', fontsize=9)
ax.text(0.15,0.05,'o)', transform=ax.transAxes, horizontalalignment='right', verticalalignment='bottom', fontsize=10, fontweight='bold')
# plt.title('Mean sea level pressure', fontsize=10)
...
plt.savefig('/home/z5147939/hdrive/figs/tnn_djf_c6_enso.png', bbox_inches='tight')
#plt.show()
