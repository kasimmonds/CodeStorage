...
#TMm
#DJF
tdjf = Dataset('/srv/ccrc/data06/z5147939/ncfiles/seasonal/tmm_DJF.nc', mode='r')

lon = tdjf.variables['lon'][:]
lat = tdjf.variables['lat'][:]
djf = tdjf.variables['tmm'][:,:,:]
...
#MAM
tmam = Dataset('/srv/ccrc/data06/z5147939/ncfiles/seasonal/tmm_MAM.nc', mode='r')
mam = tmam.variables['tmm'][:,:,:]
...
#JJA
tjja = Dataset('/srv/ccrc/data06/z5147939/ncfiles/seasonal/tmm_JJA.nc', mode='r')
jja = tjja.variables['tmm'][:,:,:]
...
#SON
tson = Dataset('/srv/ccrc/data06/z5147939/ncfiles/seasonal/tmm_SON.nc', mode='r')
son = tson.variables['tmm'][:,:,:]
...
cb.ax.tick_params(labelsize=7)
cb.set_label('Correlation', fontsize=8)
plt.savefig('/home/z5147939/hdrive/figs/tmm_awap.png', bbox_inches='tight')
plt.show()
