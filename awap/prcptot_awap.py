...
#TMm
#DJF
tdjf = Dataset('/srv/ccrc/data06/z5147939/ncfiles/seasonal/prcptot_DJF.nc', mode='r')

lon = tdjf.variables['lon'][:]
lat = tdjf.variables['lat'][:]
djf = tdjf.variables['prcptot'][:,:,:]
...
#MAM
tmam = Dataset('/srv/ccrc/data06/z5147939/ncfiles/seasonal/prcptot_MAM.nc', mode='r')
mam = tmam.variables['prcptot'][:,:,:]
...
#JJA
tjja = Dataset('/srv/ccrc/data06/z5147939/ncfiles/seasonal/prcptot_JJA.nc', mode='r')
jja = tjja.variables['prcptot'][:,:,:]
...
#SON
tson = Dataset('/srv/ccrc/data06/z5147939/ncfiles/seasonal/prcptot_SON.nc', mode='r')
son = tson.variables['prcptot'][:,:,:]
...
cmap2.set_bad(color='0.8', alpha = None)
mymap= m.pcolor(xi, yi, corrdjf, norm=norm, cmap=cmap2)
ss_djf = np.ma.masked_invalid(ss_djf)
...
cb.ax.tick_params(labelsize=7)
cb.set_label('Correlation', fontsize=8)
plt.savefig('/home/z5147939/hdrive/figs/prcptot_awap.png', bbox_inches='tight')
plt.show()
