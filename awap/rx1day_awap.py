...
#TMm
#DJF
tdjf = Dataset('/srv/ccrc/data06/z5147939/ncfiles/seasonal/rx1day_DJF.nc', mode='r')

lon = tdjf.variables['lon'][:]
lat = tdjf.variables['lat'][:]
djf = tdjf.variables['rx1day'][:,:,:]
...
#MAM
tmam = Dataset('/srv/ccrc/data06/z5147939/ncfiles/seasonal/rx1day_MAM.nc', mode='r')
mam = tmam.variables['rx1day'][:,:,:]
...
#JJA
tjja = Dataset('/srv/ccrc/data06/z5147939/ncfiles/seasonal/rx1day_JJA.nc', mode='r')
jja = tjja.variables['rx1day'][:,:,:]
...
#SON
tson = Dataset('/srv/ccrc/data06/z5147939/ncfiles/seasonal/rx1day_SON.nc', mode='r')
son = tson.variables['rx1day'][:,:,:]
...
cb.ax.tick_params(labelsize=7)
cb.set_label('Correlation', fontsize=8)
plt.savefig('/home/z5147939/hdrive/figs/rx1day_awap.png', bbox_inches='tight')
plt.show()
