...
#TMm
#DJF
tdjf = Dataset('/srv/ccrc/data06/z5147939/ncfiles/seasonal/tnn_3m_DJF.nc', mode='r')

lon = tdjf.variables['lon'][:]
lat = tdjf.variables['lat'][:]
djf = tdjf.variables['tnn'][:,:,:]
...
#MAM
tmam = Dataset('/srv/ccrc/data06/z5147939/ncfiles/seasonal/tnn_3m_MAM.nc', mode='r')
mam = tmam.variables['tnn'][:,:,:]
...
#JJA
tjja = Dataset('/srv/ccrc/data06/z5147939/ncfiles/seasonal/tnn_3m_JJA.nc', mode='r')
jja = tjja.variables['tnn'][:,:,:]
...
mymap= m.pcolor(xi, yi, ss_djf, hatch = '...', norm=norm, cmap=plt.cm.bwr)
...
cb.ax.tick_params(labelsize=7)
cb.set_label('Correlation', fontsize=8)
plt.savefig('/home/z5147939/hdrive/figs/tnn_awap.png', bbox_inches='tight')
plt.show()
